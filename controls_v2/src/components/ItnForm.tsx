import React, { useCallback, useImperativeHandle, useState, useRef, FunctionComponent, ReactElement, useMemo } from "react";
...
const ItnForm = React.forwardRef<IFormRef, IFormProps>((props, ref) => {
    ...
    const [entity, setEntity] = useState<any | null>(props.entity);
    const [loading, setLoading] = useState<boolean>(formType !== "create");
    const [saving, setSaving] = useState<boolean>(false);

    const fields = useMemo(() => props.fieldBuilder.Build(), []);
    ...
    }, [props.onChange, entity, setEntity]);
    ...
    }, [entity, validateControls, props.onSave, setSaving]);
