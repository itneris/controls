...
import { FileControlProps } from "../types/ControlProps";
import { compressImageToSize } from "../util/compressImageToSize";
    ...
    return (
        <>
            ...
            <FormControl>
                ...
                <FormHelperText error={isError}>{isError ? errorText : (helperText ?? "")}</FormHelperText>
                {
                    fileError &&
